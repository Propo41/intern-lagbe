...
export default function ReportMoreMenu(props) {
  ...
  const onDeleteClick = async (e) => {
    ...
    setAlertContent({
      title: "Are you sure?",
      subtitle:
        "This action is irreversible and will delete the report permanently.",
    });
    // open a confirm dialog
    // if the user clicks ok, delete the report
    setAlertOpen(true);
  };
  ...
  const deleteReport = async () => {
    ...
    form.append("id", props.report.id);
    try {
      const { data } = await DELETE_AUTH(`admin/report/delete`, form);
      console.log(data);
      ...
      >
        ...
        >
          ...
          >
            <Fade in={open}>
              <div>
                <ViewReportModal report={props.report} />
              </div>
            </Fade>
          </Modal>
        </MenuItem>
